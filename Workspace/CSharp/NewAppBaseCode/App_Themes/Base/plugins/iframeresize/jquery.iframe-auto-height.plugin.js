    ...
    $.fn.iframeAutoHeight = function (spec) {
        ...
        return this.each(function () {
            ...
            strategies['default'] = function (iframe, $iframeBody, options, browser) {
                if ($('iframe')[0]) {
                    return $($($('iframe')[0].contentWindow.document).children().children()[1]).children().height() + 100 + options.heightOffset;
                } else {
                    return 100 + options.heightOffset;
                }

                // NOTE: this is how the plugin determines the iframe height, override if you need custom
                /*var $level1 = $($('iframe')[0].contentWindow.document);
                ...
                var $level3 = $level2.children();
                if ($level3.lenght > 0) {

                var $level4 = $($level3[1]).children();
                if ($level4.lenght > 0) {
                return $($($('iframe')[0].contentWindow.document).children().children()[1]).children().height() + options.heightOffset;
                }
                }
                }
                } else {
